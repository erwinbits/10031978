        ...
        <?php
            if(isset($_GET['forApproval'])){
                echo '<ul class="nav nav-tabs">
					<li role="presentation" ><a href="Item_List">My Items</a></li>
					<li role="presentation" class="active"><a href="Item_List?forApproval">Items For Approval</a></li>
					<li role="presentation"><a href="Item_List?Rejected">Rejected Items</a></li>
                </ul>';
				$chkbx = "";
            }elseif(isset($_GET['Rejected'])){
				echo '<ul class="nav nav-tabs">
					<li role="presentation" ><a href="Item_List">My Items</a></li>
					<li role="presentation"><a href="Item_List?forApproval">Items For Approval</a></li>
					<li role="presentation" class="active"><a href="Item_List?Rejected">Rejected Items</a></li>
				</ul>';
				$chkbx = "";
			}else{
				echo '<ul class="nav nav-tabs">
					<li role="presentation" class="active"><a href="Item_List">My Items</a></li>
					<li role="presentation"><a href="Item_List?forApproval">Items For Approval</a></li>
					<li role="presentation" ><a href="Item_List?Rejected">Rejected Items</a></li>
				</ul>';
