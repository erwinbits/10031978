<?php
	...
	if(isset($_POST['serviceFee'])){
		...
		//$serviceName = $_POST['compname'];
		var_dump($serviceFee);
		$eip = new eIP; //instantiate
		
		
			$result = $eip->updateFee($id, $serviceFee);
			
			$status = "";
			$responseMessage = "";
			
			if($result != "Updating data failed"){
...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<a href="clientList" class="btn btn-default btn-block"><i class="fa fa-reply fa-fw"></i> Back</a>
		</div>
