...
include('../includes/ClientLayout.php'); 
	...
	if($_POST){
		...
		for($i=0;$i<$count;$i++){
			...
			$LOAno = strtoupper($_POST['LOAno'][$i]);
			$LOAValidity = strtoupper($_POST['LOAValidity'][$i]);
		
			$result = $items->addeIPitems($HSCODE, $itemCode, $description, $itemName, $TAR_Ext, $regAct, $frequency, $LOAno, $LOAValidity, $zone, $cltcode);
		}
		//var_dump($_POST);
		if ($result){
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
    					...
    					<table class="table">
							...
							<thead align="center">
								<th><center>#</center></th>
								<th><center>LOA no</center></th>
								<th><center>LOA Validity</center></th>
							...
							<tbody id="p_scents">
								<tr>
									...
									<td><input class="form-control input-required" type="text" name="LOAno[]" placeholder="LOA no" required></td>
									
									<td><input class="form-control input-required" type="date" name="LOAValidity[]" required></td>
