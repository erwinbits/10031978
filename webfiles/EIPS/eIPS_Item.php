        ...
        <?php
            if(isset($_GET['forApproval'])){
                echo '<ul class="nav nav-tabs">
					<li role="presentation" ><a href="eIPS_Item">My Items</a></li>
					<li role="presentation" class="active"><a href="eIPS_Item?forApproval">Items For Approval</a></li>
					<li role="presentation"><a href="eIPS_Item?Rejected">Rejected Items</a></li>
                </ul>';
				$chkbx = "";
            }elseif(isset($_GET['Rejected'])){
				echo '<ul class="nav nav-tabs">
					<li role="presentation" ><a href="eIPS_Item">My Items</a></li>
					<li role="presentation"><a href="eIPS_Item?forApproval">Items For Approval</a></li>
					<li role="presentation" class="active"><a href="eIPS_Item?Rejected">Rejected Items</a></li>
				</ul>';
				$chkbx = "";
			}else{
				echo '<ul class="nav nav-tabs">
					<li role="presentation" class="active"><a href="eIPS_Item">My Items</a></li>
					<li role="presentation"><a href="eIPS_Item?forApproval">Items For Approval</a></li>
					<li role="presentation" ><a href="eIPS_Item?Rejected">Rejected Items</a></li>
				</ul>';
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="items" name="ImportablesForm" method="POST" action="Apply_eIPS">
                        ...
                        if(isset($_GET['forApproval'])){
                            ...
                            echo '<div class="row-fluid control-group">
                                    <button type="submit" name="eCert" class="btn btn-inverse inline">Create eIPS</button>
                        ...
                        //removed 
                        ?>
                       <!--  <button type="submit" name="Approve" class="btn btn-inverse inline">Approve eIPS</button> -->
                    </form>  
                </div>
            </div>
        </div>
