		...
		<div class="container-fluid">
			...
			<form class="form-horizontal" id="ImportablesForm" name="ImportablesForm" action="viewEcert" method="POST">
                    ...
                    <div class="panel-body">
                        <table style="margin:0 auto;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" id="zone" type="text" value="" placeholder="Zone Location"  name="ZoneLoc" readonly tabindex="-1">
                                </div>
                            </div>
                ...
                <div class="form-group text-right">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary"  <?php if(!isset($_POST['chk'])){echo 'disabled';}?>>View</button>
