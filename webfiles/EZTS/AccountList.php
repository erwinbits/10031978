                    ...
                    <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="company_name" data-sort-order="">
                        <thead>
                            <tr>
                                ...
                                <th data-field="runningBal"  data-sortable="false">CURRENT BALANCE</th>
                                <th data-field="LastReload"  data-sortable="false">LAST RELOAD</th>
                                <th>ACTION</th>
                            </tr>
                        </thead>
                        ...
                        <?php
                            ...
                            foreach($list as $data){
								...
								$fee = $eip->getclientFee($id);
                                    ...
                                    $list2 = $accountlist->getCurrentBalandLastReload($id);

                                    foreach ($list2 as $value) {
                                        $currentBal = number_format($value['runningBal'],2);
                                        $LastReload = $value['LastReload'];
                                ...
                                echo "<tr>
                                        ...
                                        <td>$ZONE_CODE</td>
                                        <td>$fee</td>
                                        <td>PHP$currentBal</td>
                                        <td>$LastReload</td>
                                        <td> <a class=\"btn btn-default btn-xs\" href=\"AddFund?cltcode=".$cltcode."&&compname=".$compname."&&id=".$id."\" title=\"Add Fund\">Add Fund</a></td>
                                     </tr>";
