    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs">
              ...
              <li role="presentation" class="active"><a href="ELSEmyECERTforApproval">For Approval Items</a></li>
              <li role="presentation"><a href="ELSEmyECERTrejected">Rejected Items</a></li>
            </ul>
