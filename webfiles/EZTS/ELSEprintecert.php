...
$elsezoneloc = $ecert->getZoneEcozoneName($ELSEZone);
	...
	$procurement = $ecert->getAllFromProcurementTable($ecertno);
        ...
        <p></strong>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="company" value="1" checked="'.$checkcompany.'" readonly="true"/>our appointed <strong>Warehouse/Logistics Service Provider</strong> which will procure and store for subsequent sale/delivery to our facility, the goods described below either thru:</p>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="domesticEnterprise" value="1" checked="'.$checkd.'" readonly="true"/><label for="indirect">Domestic Enterprise</label></td>
            </tr>
            <tr>
                <td></td>

                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="peza" value="1" checked="'.$checkp.'" readonly="true"/><label for="peza">PEZA</label></td>
            </tr>
            <tr>
                <td></td>
        ...
        $html .= '<br><strong>' . $ecertdata['ELSEname'] . '</strong> is a PEZA-registered Ecozone Logistics Service Enterprise (ELSE) or Ecozone Facilities enterprise engaged in warehousing/logistics operations under C.R. No.: <strong>' . $elsePEZACOR . '</strong> dated <strong>' .$account->getPEZACorRegDate($ELSEname).'</strong> with facility located in <strong>' . $elsezoneloc .'</strong>.
        <br><br><br><br>';
