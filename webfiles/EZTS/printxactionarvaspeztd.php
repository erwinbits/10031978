...
$refnum = $_GET['refnum'];
$AR = $print->getxActiondetailsVASPeztd($refnum);
...
$pdf->AddPage();
	...
	foreach($AR as $data) { 
		...
		<table border = "0">
			<tr>
				<td width = "60%"> Received from: &nbsp; : &nbsp; <strong> '.$company.'</strong></td>
				<td width = "40%"> Date: &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <strong>'.$newDate.'</strong></td>
			</tr>
			<br>

			<tr>
				<td width = "60%"> Payment For: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; <strong>'.$data['transaction_type'].'</strong></td>
				<td width = "40%"> Trans ID: &nbsp; : <strong>'.$data['transactionID'].'</strong></td>
			</tr>
			<br>
