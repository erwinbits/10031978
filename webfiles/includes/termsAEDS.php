...
<html lang="en">
<!-- EIP Modal -->
	<div class="modal fade" id="termsAEDS" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" name="AEDSService" class="btn btn-primary">Apply for EZTS</button>
	      </div>
	    </div>
	  </div>
	</div>
