	...
	<ul class="user-menu">
        <li class="dropdown pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="ELSEprofilePage"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                <li><a href="ELSEaccountPage"><span class="glyphicon glyphicon-usd"></span> Account</a></li>
